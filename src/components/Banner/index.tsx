...
export default function Banner(){
    ...
    return(
        <section ref={ref} style={intersectionStyle} >
            <div className="flex w-[80%] justify-between items-center mx-auto">
                <div className="w-[30%] space-y-10">
                    ...
                    <ul className="flex items-center gap-8 my-5">
                ...
                <div style={ { translate: 'translateX(100%)', transform: 'all is ease-in-out' } } className="relative w-[70%]">
                    <img 
